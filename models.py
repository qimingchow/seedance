...
class Generation(Base):
    ...
    video_tos_key: Mapped[str] = mapped_column(String(512), default="")
    audio_tos_key: Mapped[str] = mapped_column(String(512), default="")
    last_frame_tos_key: Mapped[str] = mapped_column(String(512), default="")
